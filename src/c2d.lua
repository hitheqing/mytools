...
function c2d.pso_kick_action_req(point_id, point_index)
	print(bWriteLog and string.format("c2d.pso_kick_action_req point_id:%s, point_index",point_id, point_index))
end
...
function c2d.pso_overlap_result_req(score)
	print(bWriteLog and string.format("c2d.pso_overlap_result_req score",score))
end
